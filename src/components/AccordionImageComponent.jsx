...
const AccordionImageComponent = () => {
  ...
  const handleAccordionClick = (index) => {
    setSelectedAccordion((prevIndex) => (prevIndex === index ? prevIndex : index));
  };
  ...
  return (
    ...
    <motion.div
      ...
      >
        ...
        We prioritize data security, ensuring the steadfast integrity and exclusivity <br /> of your code is meticulously upheld.
        </p>
      </motion.div>
        ...
        {accordionData.map((item, index) => (
          ...
          >
            <div className="flex justify-between mb-3">
              <span className='text-[2rem] flex gap-2 items-center'><GiNinjaStar className='mt-1' />{item.title}</span>
              <motion.div
                initial={false}
      ...
      <div className="flex flex-wrap  justify-center">
        {items.slice(0, 3).map(({ id, icon, header, text }) => (
          ...
          >
            ...
            <h2 className="text-lg md:text-[2rem] font-bold mb-4">{header}</h2>
